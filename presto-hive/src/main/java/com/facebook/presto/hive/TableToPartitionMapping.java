...
public class TableToPartitionMapping
{
    ...
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(TableToPartitionMapping.class).instanceSize();
    private static final int INTEGER_INSTANCE_SIZE = (int) ClassLayout.parseClass(Integer.class).instanceSize();
    private static final int OPTIONAL_INSTANCE_SIZE = (int) ClassLayout.parseClass(Optional.class).instanceSize();
