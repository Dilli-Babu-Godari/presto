...
public class HiveBloomFilter
        ...
        implements Hashable
{
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(HiveBloomFilter.class).instanceSize() + (int) ClassLayout.parseClass(BitSet.class).instanceSize();
