...
{
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(LongDictionaryBuilder.class).instanceSize() + (int) ClassLayout.parseClass(LongArrayList.class).instanceSize();
