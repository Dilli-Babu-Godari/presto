...
public class OrcWriteValidation
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(RowGroupStatistics.class).instanceSize();
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(OrcWriteValidationBuilder.class).instanceSize();
