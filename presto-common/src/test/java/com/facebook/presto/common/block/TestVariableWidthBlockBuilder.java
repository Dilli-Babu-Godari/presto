...
{
    private static final int BLOCK_BUILDER_INSTANCE_SIZE = (int) parseClass(VariableWidthBlockBuilder.class).instanceSize();
    private static final int SLICE_INSTANCE_SIZE = (int) parseClass(DynamicSliceOutput.class).instanceSize() + (int) parseClass(Slice.class).instanceSize();
