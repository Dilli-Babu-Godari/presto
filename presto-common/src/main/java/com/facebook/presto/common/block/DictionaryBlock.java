...
public class DictionaryBlock
        implements Block
{
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(DictionaryBlock.class).instanceSize() + (int) ClassLayout.parseClass(DictionaryId.class).instanceSize();
