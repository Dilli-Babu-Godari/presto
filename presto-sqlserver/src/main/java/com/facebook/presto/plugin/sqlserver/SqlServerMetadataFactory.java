        ...
        extends JdbcMetadataFactory
{
    ...
    @Inject
    public SqlServerMetadataFactory(JdbcMetadataCache jdbcMetadataCache, SqlServerClient sqlServerClient, JdbcMetadataConfig config, TableLocationProvider tableLocationProvider)
    {
        super(jdbcMetadataCache, sqlServerClient, config, tableLocationProvider);
    ...
    @Override
    public SqlServerMetadata create()
    {
