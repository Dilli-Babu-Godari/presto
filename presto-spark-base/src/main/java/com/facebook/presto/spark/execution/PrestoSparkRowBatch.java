...
{
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(PrestoSparkRowBatch.class).instanceSize();
    ...
    {
        private static final int BUILDER_INSTANCE_SIZE = (int) ClassLayout.parseClass(PrestoSparkRowBatchBuilder.class).instanceSize();
