        ...
        implements AccumulatorStateFactory<HyperLogLogState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedHyperLogLogState.class).instanceSize();
    ...
    public static class SingleHyperLogLogState
            implements HyperLogLogState
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleHyperLogLogState.class).instanceSize();
