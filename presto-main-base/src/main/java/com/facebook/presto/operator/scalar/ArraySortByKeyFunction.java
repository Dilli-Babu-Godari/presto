...
public final class ArraySortByKeyFunction
{
    ...
    @TypeParameter("T")
    @TypeParameter("K")
    @TypeParameterSpecialization(name = "K", nativeContainerType = int.class)
    @SqlType("array(T)")
    public static Block sortInt(
            ...
            @SqlType("function(T, K)") UnaryFunctionInterface function)
    {
        return sort(elementType, keyType, array, function);
    }
        ...
        for (int i = 0; i < arrayLength; i++) {
            ...
            if (array.isNull(i)) {
                ...
                try {
                    ...
                    throw new PrestoException(INVALID_FUNCTION_ARGUMENT, "Error applying key function", t);
                }
            }
        }
    ...
    private static Object getElementValue(Type elementType, Block array, int position)
    {
        ...
        if (javaType == long.class) {
            ...
            return (int) elementType.getLong(array, position);
        }
