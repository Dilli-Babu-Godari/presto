        ...
        implements AccumulatorStateFactory<MinMaxNState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedMinMaxNState.class).instanceSize();
    ...
    public static class SingleMinMaxNState
            implements MinMaxNState
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleMinMaxNState.class).instanceSize();
