        ...
        implements AccumulatorStateFactory<LongDecimalWithOverflowAndLongState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedLongDecimalWithOverflowAndLongState.class).instanceSize();
    ...
    public static class SingleLongDecimalWithOverflowAndLongState
            ...
            implements LongDecimalWithOverflowAndLongState
    {
        public static final int SIZE = (int) ClassLayout.parseClass(Slice.class).instanceSize() + UNSCALED_DECIMAL_128_SLICE_LENGTH + SIZE_OF_LONG * 2;
