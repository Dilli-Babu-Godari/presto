        ...
        implements AccumulatorStateFactory<MapUnionSumState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedState.class).instanceSize();
        private final Type keyType;
        private final Type valueType;
        private final Adder adder;
    ...
    public static class SingleState
            implements MapUnionSumState
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleState.class).instanceSize();
        private final Type keyType;
        private final Type valueType;
        private final Adder adder;
