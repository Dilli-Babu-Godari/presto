        ...
        implements AccumulatorStateFactory<SfmSketchState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedSfmSketchState.class).instanceSize();
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleSfmSketchState.class).instanceSize();
