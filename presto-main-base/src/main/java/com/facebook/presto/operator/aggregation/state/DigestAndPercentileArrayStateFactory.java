        ...
        implements AccumulatorStateFactory<DigestAndPercentileArrayState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedDigestAndPercentileArrayState.class).instanceSize();
    ...
    public static class SingleDigestAndPercentileArrayState
            implements DigestAndPercentileArrayState
    {
        public static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleDigestAndPercentileArrayState.class).instanceSize();
