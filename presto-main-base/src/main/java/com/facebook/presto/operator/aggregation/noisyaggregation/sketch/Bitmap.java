...
public class Bitmap
{
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(Bitmap.class).instanceSize();
    private static final int BITSET_INSTANCE_SIZE = (int) ClassLayout.parseClass(BitSet.class).instanceSize();
