        ...
        implements AccumulatorStateFactory<MinMaxByNState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedMinMaxByNState.class).instanceSize();
    ...
    public static class SingleMinMaxByNState
            implements MinMaxByNState
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleMinMaxByNState.class).instanceSize();
