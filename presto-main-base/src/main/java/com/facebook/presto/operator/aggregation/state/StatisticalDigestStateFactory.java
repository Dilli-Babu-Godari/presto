        ...
        implements AccumulatorStateFactory<StatisticalDigestState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedStatisticalDigestState.class).instanceSize();
    ...
    public static class SingleStatisticalDigestState<T>
            implements StatisticalDigestState
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleStatisticalDigestState.class).instanceSize();
        private final Function<Slice, StatisticalDigest<T>> deserializer;
