        ...
        implements AccumulatorStateFactory<DigestAndPercentileState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedDigestAndPercentileState.class).instanceSize();
    ...
    public static class SingleDigestAndPercentileState
            implements DigestAndPercentileState
    {
        public static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleDigestAndPercentileState.class).instanceSize();
