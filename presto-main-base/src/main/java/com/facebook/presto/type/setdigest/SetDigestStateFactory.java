...
{
    private static final int SIZE_OF_SINGLE = (int) ClassLayout.parseClass(SingleSetDigestState.class).instanceSize();
    private static final int SIZE_OF_GROUPED = (int) ClassLayout.parseClass(GroupedSetDigestState.class).instanceSize();
