...
public class SetDigest
{
    ...
    private static final int SIZE_OF_SETDIGEST = (int) ClassLayout.parseClass(SetDigest.class).instanceSize();
    private static final int SIZE_OF_RBTREEMAP = (int) ClassLayout.parseClass(Long2ShortRBTreeMap.class).instanceSize();
