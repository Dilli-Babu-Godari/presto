...
{
    private static final int SIZE_OF_SINGLE = (int) ClassLayout.parseClass(SingleKHyperLogLogState.class).instanceSize();
    private static final int SIZE_OF_GROUPED = (int) ClassLayout.parseClass(GroupedKHyperLogLogState.class).instanceSize();
