        ...
        implements AccumulatorStateFactory<SpatialPartitioningState>
{
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(GroupedSpatialPartitioningState.class).instanceSize();
    ...
    {
        private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(SingleSpatialPartitioningState.class).instanceSize();
